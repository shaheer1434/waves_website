...
const About = () => {
  return (
      ...
      <div className="container my-5">
        <div className="row">
          ...
          <p className="text-secondary">
            Waves Technology was established in 2021 as professional IT
    ...
    style={{ backgroundColor: "#211F3B",  backgroundImage: `url(${"aboutimage1.png"})`, backgroundRepeat: "no-repeat" }}
>
    <div className="mx-5">
        <img
