  ...
  return (
    <div>
      ...
      <div className="container">
          ...
          <h1 className="text-center fw-bold">Custom Software Development</h1>
      </div>
      ...
      <div>
        ...
        <div className="d-flex align-items-center">
        <h4>Custom Software Integrations</h4>
        <img src="/src/images/5.png" alt="" className="mx-2 my-2" style={{width:"8vh"}}/>
        </div>
      </div>
      <div><img src="/app-watch-1.jpg" alt="img" /></div>
      <div>
      <div>
        <div className="d-flex align-items-center">
        ...
        <div className="d-flex align-items-center">
        <img src="/src/images/3.png" alt="" className="mx-2 my-2 ms-4" style={{width:"8vh"}}/>
