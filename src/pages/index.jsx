  ...
  return (
    <>
      ...
      >
        <div className="container pt-5">
          <div className="justify-content-center">
            <div>
            <h1
              className="text-light  text-center mt-5 mb-4 big-heading"
              style={{
            ...
            {home_banner.map((item) => (
              ...
              >
                ...
                <Link to={generateTargetUrl(item.id)} className="text-decoration-none">
                    <div className="cards mx-3 d-flex flex-column align-items-center">
                      <div className="card-icon text-center text-light fa-2x">
                        <img src={item.icon} className="my-2 pe-2" alt={item.title} />
                      </div>
                      <h5
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${"homeimage4.png"})`,
          backgroundRepeat: "no-repeat",
          height: "100vh",
        }}
      >
        <h6 className="s-heading">WE ARE WAVESTECHNOLOGY</h6>
      ...
      <div
        ...
        style={{
          backgroundImage: `url(${"homeimage3BG.jpg"})`,
          backgroundSize: "cover",
          // height: "90vh",
        }}
      >
